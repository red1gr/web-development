...
export const Hero   = () => {
  ...
  const VIDEO_KEYS = ["hero1", "hero2", "hero3"] as const;
      ...
      {isLoading && (
        <div className="flex-center absolute z-[100] h-dvh w-screen overflow-hidden bg-white">
          <div className="three-body">
            <div className="three-body__dot" style={{ backgroundColor: "#0000ff" }} />
            <div className="three-body__dot" style={{ backgroundColor: "#0000ff" }} />
            <div className="three-body__dot" style={{ backgroundColor: "#0000ff" }} />
          </div>
        </div>
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">
              We craft optimized FiveM scripts for smooth realistic, immersive roleplay experiences.
            </p>
            <a href="https://discord.rdstorefivem.com" target="_blank" rel="noopener noreferrer">
              <Button
                id="watch-trailer"
                leftIcon={TiLocationArrow}
                containerClass="bg-[#0000FF] flex-center gap-1 text-white"
              >
                GET STARTED
              </Button>
            </a>
