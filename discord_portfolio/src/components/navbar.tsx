...
const NAV_ITEMS = [
  ...
  { label: "CHANGE LOGS", href: "https://updates.rdstorefivem.com/" },
      ...
      <div className="absolute top-1/2 w-full -translate-y-1/2">
        <nav className="flex size-full items-center justify-between p-4">
          <div className="flex items-center gap-7">
            <a href="https://rdstorefivem.com" className="transition hover:opacity-75">
              <img src="https://r2.fivemanage.com/e9ayQ4VVHnYGIcG9ROsZf/logo_w.png" alt="Logo" className="w-16" />
            </a>
          </div>
